#' \strong{aba.query() - Query aba results for all positive results}
#' 
...
#' \strong{aba.wrapper() - single function to query and plot the aba colocs
#' 
#' @author Karsten Sieber \email{karsten.b.sieber@@gsk.com}
#' @param analysis_ids ukbiobank analysis id(s), single string or vector.
#' @param hgncid HGNC symbol. Single string or vector. 
...
#' \strong{aba.save() - save aba figures
#' 
